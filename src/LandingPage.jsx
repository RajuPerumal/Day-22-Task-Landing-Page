...
import './LandingPage.css'; // Assuming your custom styles are here
    ...
    <div className="row">
      <div className="col-lg-4">
        <div className="testimonial-item mx-auto mb-5 mb-lg-0">
          <img
            ...
            src="https://img.freepik.com/free-photo/young-woman-smiling-with-long-hair_23-2149147991.jpg"
            alt="Margaret E."
          />
          <h5>Margaret E.</h5>
      ...
      <div className="col-lg-4">
        <div className="testimonial-item mx-auto mb-5 mb-lg-0">
          <img
            className="img-fluid rounded-circle mb-3"
            src="https://img.freepik.com/free-photo/cheerful-young-man-smiling_23-2148821335.jpg"
            alt="Fred S."
          />
          <h5>Fred S.</h5>
          <p className="font-weight-light mb-0">
      ...
      <div className="col-lg-4">
        <div className="testimonial-item mx-auto mb-5 mb-lg-0">
          <img
            className="img-fluid rounded-circle mb-3"
            src="https://img.freepik.com/free-photo/young-woman-holding-coffee-cup_23-2149162021.jpg"
            alt="Sarah W."
          />
          <h5>Sarah W.</h5>
          <p className="font-weight-light mb-0">
                ...
                <div className="row">
                  <div className="col">
                    <input
                      ...
                      data-sb-validations="required,email"
                    />
                    <div className="invalid-feedback" data-sb-feedback="emailAddressBelow:required">
                      Email Address is required.
                    </div>
                    <div className="invalid-feedback" data-sb-feedback="emailAddressBelow:email">
                      Email Address Email is not valid.
                    </div>
                  </div>
                  <div className="col-auto">
